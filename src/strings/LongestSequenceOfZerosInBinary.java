...
public class LongestSequenceOfZerosInBinary {
...
//    representation '100000' and thus no binary gaps.
    public static int solution(int N) {
        ...
        int numberOfMaxConsecutiveZeros = 0;

        for (int i = 0; i < binaryString.length(); i++) {
            if (binaryString.charAt(i) == '1') {
                if (countConsecutiveZeros > numberOfMaxConsecutiveZeros) {
                    numberOfMaxConsecutiveZeros = countConsecutiveZeros;
                }
        ...
        return numberOfMaxConsecutiveZeros;
    }
...
//        int N = 15;   // result 0
//        int N = 32;   // result 0
//        int N = 561892;   // result 3
//        int N = 74901729;   // result 4
        int N = 1376796946;   // result 5
